...
.settings-tab-btn svg { width:15px; height:15px; }
    ...
    <div class="settings-panel active" id="stab-profile">
      ...
      <div class="form-row">
        <div class="form-group">
          ...
          <input class="form-input" type="text" id="profDesig" placeholder="e.g. Research Specialist"/>
        </div>
        <div class="form-group">
    ...
    <div class="settings-panel" id="stab-security">
      ...
      <div class="form-row" style="max-width:480px">
        ...
        <div class="form-group">
          ...
          <input class="form-input" type="password" id="pwNew" placeholder="Min. 8 characters" autocomplete="new-password"/>
        </div>
        <div class="form-group">
...
async function loadProfile() {
  try {
    ...
    if (json.user) {
      ...
      document.getElementById('profDesig').value     = json.user.designation || '';
      if (json.user.email) document.getElementById('profEmail').value = json.user.email;
      if (json.user.photo) document.getElementById('avatarPreview').src = '/' + json.user.photo;
      // Initials fallback
...
async function changePassword() {
  ...
  if (!cur || !nw) { showToast('All fields are required.'); return; }
  ...
  if (json.ok) { document.getElementById('pwCurrent').value = document.getElementById('pwNew').value = document.getElementById('pwConfirm').value = ''; }
}
...
document.getElementById('avatarFile').addEventListener('change', function() {
  ...
  reader.onload = e => { document.getElementById('avatarPreview').src = e.target.result; document.getElementById('avatarPreview').style.display='block'; };
