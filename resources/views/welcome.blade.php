...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const institutions = [
    { name:'Isabela State University - Echague', sub:'Echague, Isabela', logo:'8. Isabela_State_University.png', tag:'State University', category:'academic', desc:'Main campus leading agro-industrial R&D, smart agriculture, and forestry innovations in Isabela.' },
