/**
 * render-t7a.js — Report renderer for Table 7a: Databases Developed/Enhanced and Maintained
...
(function () {
  ...
  window.renderT7a = function (container, allRows) {
    ...
    allRows.forEach(inst => {
      ...
      html += `<details class="rpt-detail-block">
        <summary><strong>${esc(inst.institution || '—')}</strong> — ${rows.length} database(s)</summary>`;
