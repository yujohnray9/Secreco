 ...
 * by the Consortium and member-agencies in support of regional priorities, CY 2025.
...
(function () {
  ...
  function buildShell() {
    ...
    <div class="t-page" id="t8b_wrap">
      <div class="t-hdr">
        <div class="t-title">Table 8b. Collaborative R&amp;D Programs/ Projects implemented by the Consortium and member-agencies in support of regional priorities, CY 2025 (January – December).</div>
      </div>
      ...
      <div style="display:flex;gap:8px;align-items:center;flex-wrap:wrap">
        <button class="btn btn-primary" onclick="T8b.save()">Save</button>
        <button class="btn t-docs-btn" onclick="T8b.openDocs()">
          📎 Documentation <span id="t8b_docs_count" class="t-docs-badge" style="display:none">0</span>
        </button>
  ...
  function makeRow(data = {}, removable = false) {
    ...
    tr.innerHTML = `
      ...
      <td style="text-align:center">
        ${removable ? `<button class="row-remove-btn" onclick="this.closest('tr').remove();T8b._renumber();T8b._recalc()">🗑</button>` : ''}
      </td>
    `;
