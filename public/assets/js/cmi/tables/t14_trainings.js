  ...
  function buildShell() {
    ...
    <div class="t-page" id="t14_wrap">
      ...
      <div style="display:flex;gap:8px;align-items:center;flex-wrap:wrap">
        <button class="btn btn-primary" onclick="T14.save()">Save</button>
        <button class="btn t-docs-btn" onclick="T14.openDocs()">
          📎 Documentation <span id="t14_docs_count" class="t-docs-badge" style="display:none">0</span>
        </button>
  ...
  function makeRow(data = {}, removable = false) {
    ...
    tr.innerHTML = `
      ...
      <td style="text-align:center">
        ${removable ? `<button class="row-remove-btn" onclick="this.closest('tr').remove();T14._renumber()">🗑</button>` : ''}
      </td>
    `;
    return tr;
  }
